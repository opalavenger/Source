...
namespace SSoft.MVC
{
    /// <summary> 
     ...
     { 
         ...
         /// </param> 
         public ViewRender(ControllerContext controllerContext = null) 
         { 
         ...
         { 
             ViewRender render = new ViewRender(controllerContext); 
             return render.RenderViewToString(viewPath, model); 
         } 
         ...
         { 
             ViewRender render = new ViewRender(controllerContext); 
             return render.RenderPartialViewToString(viewPath, model); 
         } 
